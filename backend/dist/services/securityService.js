...
class SecurityService {
    ...
    // Log login attempt
    async logLoginAttempt(email, success, ip, userAgent, failureReason) {
        try {
    ...
    async getFailedLoginCount(email, windowMinutes = 60) {
        try {
