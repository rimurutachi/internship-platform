...
exports.getActiveRubric = getActiveRubric;
exports.getRubricById = getRubricById;
exports.getAllRubrics = getAllRubrics;
exports.createRubric = createRubric;
exports.updateRubric = updateRubric;
exports.getRubricHistory = getRubricHistory;
exports.deactivateRubric = deactivateRubric;
exports.activateRubric = activateRubric;
 ...
 */
async function getActiveRubric(universityId) {
    try {
 ...
 */
async function getAllRubrics(universityId, includeInactive = false) {
    try {
        let query = supabase
            .from('evaluation_rubrics')
            .select('*')
 ...
 * Create new rubric
 */
async function createRubric(rubricData, createdBy) {
    try {
 ...
 */
async function updateRubric(rubricId, updates, changedBy, changeReason) {
    try {
 ...
 */
async function getRubricHistory(rubricId) {
    try {
 ...
 * Deactivate rubric
 */
async function deactivateRubric(rubricId, deactivatedBy, reason) {
    try {
        // Get rubric
 ...
 */
async function activateRubric(rubricId, activatedBy) {
    try {
        // Get rubric
        const { data: rubric, error: fetchError } = await supabase
            .from('evaluation_rubrics')
 ...
 */
async function calculateGrade(rubricId, totalScore) {
    try {
        const { data: rubric, error } = await supabase
            .from('evaluation_rubrics')
        ...
        const scale = rubric.grading_scale;
 ...
 */
function getDefaultCvSURubric(universityId) {
    return {
        id: 'default-cvsu',
...
//# sourceMappingURL=rubricService.js.map