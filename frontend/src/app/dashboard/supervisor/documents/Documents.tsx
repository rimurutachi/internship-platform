...
const mockDocuments: Document[] = [
  {
    id: '1',
    name: 'Intern_Evaluation_Form.pdf',
    type: 'pdf',
    size: '2.4 MB',
    ...
    shared: true,
    sharedWith: ['Interns', 'Advisors'],
    currentVersion: 2,
    versions: [
      { version: 2, updatedBy: 'You', updatedDate: '2025-11-10', changes: 'Updated performance criteria', size: '2.4 MB' },
      { version: 1, updatedBy: 'You', updatedDate: '2025-09-01', changes: 'Initial version', size: '2.2 MB' }
    ],
  ...
  },
  {
    ...
    category: 'Guidelines',
    shared: true,
    sharedWith: ['Interns', 'Supervisors'],
    currentVersion: 1,
    versions: [
      { version: 1, updatedBy: 'HR Department', updatedDate: '2025-10-15', changes: 'Initial version', size: '1.8 MB' }
    ],
  ...
  },
  {
    ...
    category: 'Intern Reports',
    shared: true,
    sharedWith: ['You', 'Advisors'],
    currentVersion: 1,
    versions: [
  ...
  {
    id: '4',
    name: 'Team_Performance_Report.xlsx',
    type: 'xlsx',
    size: '3.2 MB',
    ...
    currentVersion: 2,
    versions: [
      { version: 2, updatedBy: 'You', updatedDate: '2025-11-15', changes: 'Added Q4 performance data', size: '3.2 MB' },
      { version: 1, updatedBy: 'You', updatedDate: '2025-11-05', changes: 'Initial version', size: '3.0 MB' }
    ],
  ...
  {
    id: '5',
    name: 'Project_Documentation.zip',
    type: 'zip',
    size: '15.3 MB',
    ...
    category: 'Projects',
    shared: true,
    sharedWith: ['Interns', 'You'],
    currentVersion: 1,
    versions: [
      { version: 1, updatedBy: 'Development Team', updatedDate: '2025-09-05', changes: 'Initial upload', size: '15.3 MB' }
    ],
    lastModified: '2025-09-05',
    lastModifiedBy: 'Development Team'
  },
  {
    id: '6',
    ...
    currentVersion: 3,
    versions: [
      { version: 3, updatedBy: 'You', updatedDate: '2025-11-12', changes: 'Added new security protocols', size: '1.1 MB' },
      { version: 2, updatedBy: 'You', updatedDate: '2025-10-20', changes: 'Updated department information', size: '1.0 MB' },
      { version: 1, updatedBy: 'You', updatedDate: '2025-10-15', changes: 'Initial checklist', size: '950 KB' }
    ],
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-muted-foreground mt-1">Manage intern documents and share resources</p>
                </div>
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Upload a new document to share with interns and advisors
                      </DialogDescription>
                    </DialogHeader>
                                  ...
                                  <div className="space-y-2">
                                    ...
                                    <div className="space-y-2">
                                      <div className="flex items-center space-x-2">
                                        <input type="checkbox" id="interns" defaultChecked={doc.sharedWith.includes('Interns')} />
                                        <Label htmlFor="interns" className="font-normal">Interns</Label>
                                      </div>
                                      <div className="flex items-center space-x-2">
                                        <input type="checkbox" id="advisors" defaultChecked={doc.sharedWith.includes('Advisors')} />
                                        <Label htmlFor="advisors" className="font-normal">Advisors</Label>
                                      </div>
                                      <div className="flex items-center space-x-2">
                                        <input type="checkbox" id="supervisors" defaultChecked={doc.sharedWith.includes('Supervisors')} />
                                        <Label htmlFor="supervisors" className="font-normal">Other Supervisors</Label>
                                      </div>
                                    </div>
                                  </div>
                                  ...
                                  <CardContent className="pt-3">
                                    <div className="space-y-2">
                                      ...
                                      <div className="text-xs space-y-1">
                                        <div><span className="font-medium">By:</span> {version.updatedBy}</div>
                                        <div><span className="font-medium">Date:</span> {new Date(version.updatedDate).toLocaleDateString()}</div>
                                        <div><span className="font-medium">Changes:</span> {version.changes}</div>
                                        <div><span className="font-medium">Size:</span> {version.size}</div>
                                      </div>
