...
exports.approveWeeklyReport = approveWeeklyReport;
exports.rejectWeeklyReport = rejectWeeklyReport;
 ...
 */
async function getStudentReports(supervisorId, filters) {
    try {
 ...
 */
async function getPendingReportsCount(supervisorId) {
    try {
        // Get all internships supervised by this supervisor
        const { data: internships, error: internshipsError } = await supabase
            .from('internships')
 ...
 */
async function approveWeeklyReport(reportId, supervisorId, comments) {
    try {
 ...
 */
async function rejectWeeklyReport(reportId, supervisorId, rejectionReason) {
    try {
 ...
 */
async function getReportStatistics(supervisorId) {
    try {
        // Get all internships supervised by this supervisor
        const { data: internships, error: internshipsError } = await supabase
            .from('internships')
 ...
 */
async function getReportsSummaryByStudent(supervisorId, internshipId) {
    try {
        // Get internships
        ...
        const summaries = await Promise.all(internships.map(async (internship) => {
 ...
 */
async function addCommentToReport(reportId, supervisorId, comment) {
    try {
...
//# sourceMappingURL=supervisorReportsService.js.map