...
import { Send, Search, Phone, Video, MoreVertical, Paperclip, Smile, ArrowLeft, Pin, Archive, Trash2, Building2 } from 'lucide-react';
...
const mockConversations: Conversation[] = [
  {
    ...
    role: 'Intern',
    avatar: 'JM',
    lastMessage: 'I have completed the assigned tasks for this week.',
  ...
  },
  {
    ...
    role: 'Intern',
    avatar: 'SC',
    lastMessage: 'Can we discuss the evaluation feedback?',
  ...
  },
  {
    ...
    role: 'Advisor',
    avatar: 'AR',
    lastMessage: 'Thank you for submitting the evaluation report.',
  ...
  },
  {
    ...
    role: 'Intern',
    avatar: 'MR',
    lastMessage: 'I submitted my weekly progress report.',
...
const mockMessages: Message[] = [
  {
    ...
    senderRole: 'Intern',
    avatar: 'JM',
    content: 'Hi Maria, I wanted to update you on my progress with the project.',
    timestamp: '10:00 AM',
    isOwn: false
  },
  {
    ...
    avatar: 'MS',
    content: 'Hi John! That\'s great. How is everything going?',
    timestamp: '10:15 AM',
    isOwn: true
  },
  {
    ...
    senderRole: 'Intern',
    avatar: 'JM',
    content: 'Everything is going well. I\'ve completed the backend API integration and I\'m now working on the frontend components.',
    timestamp: '10:20 AM',
    isOwn: false
  },
  {
    ...
    senderRole: 'Supervisor',
    avatar: 'MS',
    content: 'Excellent work! Keep it up. I\'ve reviewed your code and it looks good. Let me know if you need any assistance.',
    timestamp: '10:25 AM',
    isOwn: true,
    attachments: [{ name: 'Code_Review_Feedback.pdf', size: '1.2 MB' }]
  },
  {
    id: '5',
    sender: 'John Martinez',
    senderRole: 'Intern',
    avatar: 'JM',
    content: 'I have completed the assigned tasks for this week.',
    timestamp: '10:30 AM',
    isOwn: false
  }
];
        ...
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          <div className="flex-1 flex flex-col overflow-hidden p-6">
            ...
            <div className="mb-6 flex-shrink-0">
              ...
              <p className="text-muted-foreground mt-1">Communicate with interns, advisors, and colleagues</p>
            </div>
                    ...
                    <Dialog>
                      ...
                      <DialogContent>
                        <DialogHeader>
                          ...
                          <DialogDescription>
                            Select an intern, advisor, or colleague to message
                          </DialogDescription>
                        </DialogHeader>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {currentConversation.position || currentConversation.role}
                            </div>
      ...
      <div className="lg:hidden h-screen flex flex-col overflow-hidden">
        ...
        {!selectedConversation ? (
          ...
          <>
            ...
            <div className="border-b p-3 bg-card flex items-center gap-2 flex-shrink-0">
              <Button 
                variant="ghost" 
                size="sm" 
